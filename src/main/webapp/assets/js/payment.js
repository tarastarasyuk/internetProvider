...
const set_card_number = document.querySelector(".set_card_number");
const user_cardcvv = document.querySelector(".user_card_cvv");
const user_name_input = document.getElementById("user_name_input");
const user_card_number_input = document.getElementById("user_card_number_input");
...
function validateform() {
    let validate = true;
    const validate_inputs = document.querySelectorAll(".right-side input");

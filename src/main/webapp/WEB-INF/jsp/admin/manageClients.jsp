                    ...
                    <ul class="pagination">
                        ...
                        <c:choose>
                            <c:when test="${requestScope.currentPage != 1}">
                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/adminPanel/manageClients?page=${requestScope.currentPage - 1}">Previous</a> </li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach begin="1" end="${requestScope.noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/adminPanel/manageClients?page=${i}">${i}</a></li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        ...
                        <c:choose>
                            <c:when test="${requestScope.currentPage lt requestScope.noOfPages}">
                                <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/adminPanel/manageClients?page=${requestScope.currentPage + 1}">Next</a></li>
                            </c:when>
                            <c:otherwise>

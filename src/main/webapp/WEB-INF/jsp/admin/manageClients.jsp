        ...
        <div class="container container-table">
            <section class="users-table">
                ...
                <div class="user-table-subtitle">
                            ...
                            <button type="button" class="btn btn-success connect-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                Add a new Client
                            </button>
                            ...
                            <td class="td-action">
                                <c:choose>
                                    <c:when test='${client.getStatus().toString().equals("BLOCKED")}'>
                                        <a href="manageUsers/unblockUser"><span class="unblock-btn">UNBLOCK</span></a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="manageUsers/unblockUser"><span class="block-btn">BLOCK</span></a>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
